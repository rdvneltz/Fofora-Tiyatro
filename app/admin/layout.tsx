...
const links=[
  ['Bugün','/admin/dashboard',LayoutDashboard],['Hızlı Metin Düzenle','/admin/content',Type],['Takvim','/admin/calendar',CalendarDays],['Vitrin ve Duyurular','/admin/videos',Video],['Programlar','/admin/services',FileText],['Neler Yaptık?','/admin/impact',Sparkles],['Mesaj Kutusu','/admin/appointments',Inbox],['Bizden Haberler','/admin/blog',BookOpen],['Galeri ve Sahne Akışı','/admin/gallery',GalleryHorizontalEnd],['Ekip','/admin/team',Users],['İletişim Bilgileri','/admin/contact',Phone],['Hakkımızda','/admin/about',Info],['Yorumlar','/admin/testimonials',MessageSquareQuote],['Instagram','/admin/instagram',Instagram],['Footer Ayarları','/admin/footer',PanelBottom],['Site Ayarları','/admin/settings',Settings],
] as const
