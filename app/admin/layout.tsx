...
import { BookOpen, CalendarDays, ChevronLeft, FileText, GalleryHorizontalEnd, Inbox, LayoutDashboard, LogOut, Menu, Phone, Settings, Sparkles, Type, User, Users, Video, X } from 'lucide-react'
import { useState } from 'react'

const links=[
  ['Bugün','/admin/dashboard',LayoutDashboard],['Hızlı Metin Düzenle','/admin/content',Type],['Takvim','/admin/calendar',CalendarDays],['Vitrin ve Duyurular','/admin/videos',Video],['Programlar','/admin/services',FileText],['Neler Yaptık?','/admin/impact',Sparkles],['Mesaj Kutusu','/admin/appointments',Inbox],['Bizden Haberler','/admin/blog',BookOpen],['Galeri ve Sahne Akışı','/admin/gallery',GalleryHorizontalEnd],['Ekip','/admin/team',Users],['İletişim Bilgileri','/admin/contact',Phone],['Site Ayarları','/admin/settings',Settings],
] as const
